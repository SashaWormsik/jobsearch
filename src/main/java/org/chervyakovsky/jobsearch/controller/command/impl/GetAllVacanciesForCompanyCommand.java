...
/**
 * The {@link Command}  that finds all the vacancies for the company.
 *
...
public class GetAllVacanciesForCompanyCommand implements Command {
     ...
     * @return The router with type {@link Router.Type#FORWARD} to {@link PagePath#COMPANY_ALL_VACANCIES_PAGE}.
