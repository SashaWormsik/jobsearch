...
/**
 * The {@link Command} that updates information about the vacancy.
 *
...
public class UpdateVacancyCommand implements Command {
     ...
     * otherwise with type {@link Router.Type#FORWARD} to {@link PagePath#COMPANY_UPDATE_VACANCY_INFO_PAGE}
